...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        # ✅: Use the parent class otherwise the inheritance is irrelevant
        # INIT FROM PARENT CLASS
        super(Player, self).__init__()
        #pygame.sprite.Sprite.__init__(self)
        # ✅: The following lines can be condensed into one line and needs to properly import the image
    ...
    # ✅: The following 2 methods are not needed for this assignment
